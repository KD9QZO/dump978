...
/*! \brief Enumeration of UAT frame types */
typedef enum {
	UAT_UPLINK,		/*!< Uplink frame */
	UAT_DOWNLINK	/*!< Downlink frame */
} frame_type_t;
...
// The frame data buffer is a shared buffer owned by the caller and may be reused after return; if the handler needs to
...
// Pass complete frames to 'handler', passing 'handler_data' as the 4th argument.
//
